...
**Module 2 · Your First Prediction Model (Logistic Regression) · Decision Makers · 60-90 minutes**
:::
...
6 scenarios about model interpretation, coefficient reading, and when to use logistic regression vs. alternatives.

[→ Take the Quiz](https://docs.google.com/forms/d/e/1FAIpQLSeHiT7KkywreT3tTPQoRujrOd8fn0OIK1cUxClIqzcci4RXbQ/viewform)
:::

::: callout {icon="2️⃣"}
**Debug Drill — Bizarre Coefficients**
A model has bizarre coefficients (tenure increases churn?). Find out why and fix it.

[→ Open Debug Drill in Colab](https://colab.research.google.com/github/189investmentai/ml-foundations-interactive/blob/main/curricula/decision-makers/notebooks/debug_drills/drill_02_coefficients.ipynb)
:::

::: callout {icon="3️⃣"}
**Practice Lab — Logistic Regression**
Train a logistic regression model on StreamCart data, interpret the coefficients, compare predictions for different customer profiles, and calculate precision@500.

[→ Open Lab Notebook in Colab](https://colab.research.google.com/github/189investmentai/ml-foundations-interactive/blob/main/curricula/decision-makers/notebooks/module_02_logistic_regression.ipynb)
:::
...
One-page reference for how logistic regression works, reading coefficients, when to use it, and common mistakes.

[→ Open Cheatsheet](https://www.notion.so/310d25c7612f813aa193fbf44b94f4a9)
:::
...
<page url="https://www.notion.so/310d25c7612f813aa193fbf44b94f4a9">Module 2 Cheatsheet: Logistic Regression</page>
