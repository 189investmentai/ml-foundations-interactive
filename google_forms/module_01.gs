function createModule01() {
  ...
  var questions = [
    ...
    {
      q: 'Which of these features is SAFE to use?',
      options: [
      ...
      correct: 1,
      feedback: 'Only tenure_months is available at prediction time. The others all depend on events that happen AFTER the customer decides to churn (or involve future data).'
    },
    {
    ...
    {
      q: 'You\'ve built the model. Before deploying, you should verify:',
      options: [
      ...
      correct: 1,
      feedback: 'The key validation is HOLDOUT PERFORMANCE. A model that performs well on training data but fails on unseen data is useless. Always reserve a test set the model never sees during development.'
    },
    {
