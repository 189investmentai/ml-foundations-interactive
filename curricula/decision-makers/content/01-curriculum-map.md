...
## Optional: Appendix (Impact, Uplift, & Production)

After Module 6, you know how to build and evaluate models. But offline metrics don't prove business impact. The [Appendix](bonus-appendix-impact-uplift-production.md) covers three things the main modules don't:

1. **Experiments** — How to design an A/B test or holdout to prove your model actually moved a business metric
2. **Uplift vs. Risk** — Why targeting high-risk customers can waste money (sometimes they'd stay anyway, or they're lost causes)
3. **Production Monitoring** — What to track after launch so you catch drift before the model fails silently

If you're doing the capstone, there's also an [optional add-on notebook](../capstone/capstone_impact_validation_addon.ipynb) that walks you through designing an experiment and monitoring plan for the StreamCart churn model.
