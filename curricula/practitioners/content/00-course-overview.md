...
4. **Representations before generation (12-17):** Embeddings and retrieval are the backbone of modern AI systems. Understanding similarity search makes RAG and agents click.

5. **Agents after fundamentals (18-21):** Tool calling and guardrails make sense once you understand how models fail and how to evaluate them.

6. **Production last (22-23):** MLOps patterns depend on understanding what you're monitoring and why.
...
| **Response Generation** | RAG pipeline with LLM | 15-18 |
| **Guardrails** | Safety checks and human review triggers | 19-21 |
