...
| 16 | CNNs | `playground_cnns.html` | Convolutions, pooling, image features |
| 17 | Transformers | `playground_attention.html` | Attention, context windows |
| 18 | LLM Fundamentals | `playground_prompting.html` | Prompting, RAG basics |
| 19 | Tool Calling | `playground_tool_calling.html` | Function execution, traces |
| 20 | Agent Memory | `playground_agent_memory.html` | Context, planning |
| 21 | Guardrails | `playground_guardrails.html` | Validation, safety, eval |
| 22 | MLOps | `playground_mlops.html` | Versioning, reproducibility |
| 23 | Monitoring | `playground_drift.html` | Drift detection, alerts |
...
Modules 12-14 (Representations)
    ↓
Modules 15-17 (Deep Learning)
    ↓
Modules 18-21 (Agentic AI)
    ↓
Modules 22-23 (Production)
    ↓
Capstone
```
...
| 18-21 | Support agent with tools | Multi-task |
...
### Checkpoint 5: Deep Learning (Modules 15-17)
Intuition for neural networks and transformers.

### Checkpoint 6: Agentic AI (Modules 18-21)
Can build and evaluate tool-using agents.

### Checkpoint 7: Production (Modules 22-23)
